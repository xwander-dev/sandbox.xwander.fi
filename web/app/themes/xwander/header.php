...
<head>
	...
	?>
<!---------Custom Script for changing short name of language selected in menu ------------->
<script type="text/javascript">
	jQuery( document ).ready(function() {
	    if ( jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').attr('lang') == 'fi' ) {
	     jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').html('FI');
		} 
		if ( jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').attr('lang') == 'en' ) {
		   jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').html('EN');
		}
		if ( jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').attr('lang') == 'es' ) {
		   jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').html('ES');
		}
		if ( jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').attr('lang') == 'de' ) {
		   jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').html('DE');
		}
		if ( jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').attr('lang') == 'zh' ) {
		   jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').html('ZH');
		}
		if ( jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').attr('lang') == 'fr' ) {
		   jQuery('.wpml-ls-current-language').children().first().find('.wpml-ls-native').html('FR');
		}
	});
</script>
<!---------Custom Script end------------->
...
include('template_parts/hero.php');
